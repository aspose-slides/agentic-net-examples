// -----------------------------------------------------------------------------
// Example: Create treemap chart with gradient scale using C#
//
// Description:
// Demonstrates how to create a treemap chart with gradient scale using C# and 
...
//
// Keywords:
// C#, PowerPoint, PPTX, Aspose.Slides for .NET, Treemap, Chart, Gradient, 
// Scale, Presentation Processing, Office Automation
//
// Use Cases:
// - Automate create treemap chart with gradient scale.
