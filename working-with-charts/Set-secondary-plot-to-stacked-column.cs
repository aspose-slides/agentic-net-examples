// -----------------------------------------------------------------------------
// Example: Set secondary plot to stacked column using C#
//
// Description:
// Demonstrates how to set secondary plot to stacked column using C# and 
...
//
// Keywords:
// C#, PowerPoint, PPTX, Aspose.Slides for .NET, Secondary, Plot, Stacked, 
// Column, Presentation Processing, Office Automation
//
// Use Cases:
// - Automate set secondary plot to stacked column.
