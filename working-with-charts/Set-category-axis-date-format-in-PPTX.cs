...
namespace AsposeSlidesExample
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            IChart chart = pres.Slides[0].Shapes.AddChart(ChartType.Area, 50f, 50f, 500f, 400f);
            ...
            // Configure the category axis to use date type and a specific date format
            chart.Axes.HorizontalAxis.CategoryAxisType = CategoryAxisType.Date;
            chart.Axes.HorizontalAxis.IsNumberFormatLinkedToSource = false;
            chart.Axes.HorizontalAxis.NumberFormat = "dd-MMM-yyyy";

            // Save the presentation
            string outputPath = "DateAxisFormattedChart.pptx";
