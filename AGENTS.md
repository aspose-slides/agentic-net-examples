...
Generated examples were tested with Aspose.Slides for .NET 26.8.0 on 2026-08-20.

Examples that failed latest-version compile or runtime validation were moved to quarantine and removed from their category folders:

- `quarantine/3d-presentations/Add-PPTX-3d-circular-motion-path.cs`
- `quarantine/3d-presentations/Export-PPTX-3d-scene-to-OBJ.cs`

Quarantined examples should be fixed, retested, and restored to their category folder before publication.
