// -----------------------------------------------------------------------------
// Example: Export inkshape trace to JSON file using C#
//
// Description:
// Demonstrates how to export inkshape trace to JSON file using C# and 
...
//
// Keywords:
// C#, PowerPoint, PPTX, Aspose.Slides for .NET, Export, Inkshape, Trace, Json, 
// Presentation Processing, Office Automation
//
// Use Cases:
// - Automate export inkshape trace to JSON file.
