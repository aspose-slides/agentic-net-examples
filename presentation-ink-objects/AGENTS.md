---
name: presentation-ink-objects
description: C# examples for presentation-ink-objects using Aspose.Slides for .NET
language: csharp
framework: net10.0
parent: ../agents.md
---

# AGENTS - presentation-ink-objects

## Persona

You are a C# developer specializing in PowerPoint processing using Aspose.Slides for .NET,
working within the **presentation-ink-objects** category.

## Scope

- This folder contains examples for **presentation-ink-objects**
