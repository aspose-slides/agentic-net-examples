...
- `using System;` (206/208 files)
- `using Aspose.Slides;` (174/208 files)
- `using System.IO;` (126/208 files)
- `using System.Drawing;` (45/208 files)
- `using System.Collections.Generic;` (3/208 files)
- `using Aspose.Slides.Util;` (2/208 files)
...
- `using Aspose.Slides.Charts;` (1/208 files)
- `using System.Text.Json;` (1/208 files)
- `using System.Text;` (1/208 files)
- `using Aspose.Slides.Theme;` (1/208 files)
- `using Aspose.Slides.Animation;` (1/208 files)
...
| [Batch-add-ten-plain-lines-y-offset](./Batch-add-ten-plain-lines-y-offset.cs) |  | Batch add ten plain lines y offset |
...
| [List-rectangle-hyperlinks-to-console](./List-rectangle-hyperlinks-to-console.cs) |  | List rectangle hyperlinks to console |
...
| [Replace-rectangle-even-slides-with-rounded-colors](./Replace-rectangle-even-slides-with-rounded-colors.cs) |  | Replace rectangle even slides with rounded colors |
