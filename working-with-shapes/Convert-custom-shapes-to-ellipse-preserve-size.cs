// -----------------------------------------------------------------------------
// Example: Convert custom shapes to ellipse preserve size using C#
//
// Description:
// Demonstrates how to convert custom shapes to ellipse preserving size using C# 
...
//
// Keywords:
// C#, PowerPoint, PPTX, Aspose.Slides for .NET, Convert, Custom, Shapes, 
// Ellipse, Presentation Processing, Office Automation
//
// Use Cases:
// - Automate conversion of custom shapes to ellipses while preserving size.
