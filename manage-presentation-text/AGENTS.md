---
name: manage-presentation-text
description: C# examples for manage-presentation-text using Aspose.Slides for .NET
language: csharp
framework: net10.0
parent: ../agents.md
---

# AGENTS - manage-presentation-text

## Persona

You are a C# developer specializing in PowerPoint processing using Aspose.Slides for .NET,
working within the **manage-presentation-text** category.

## Scope

- This folder contains examples for **manage-presentation-text**
