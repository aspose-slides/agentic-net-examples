...
| [Add-click-reveal-bullet-points-animation.cs](./Add-click-reveal-bullet-points-animation.cs) |  | Add click reveal bullet points animation |
...
| [Copy-animations-from-one-slide-to-another.cs](./Copy-animations-from-one-slide-to-another.cs) |  | Copy animations from one slide to another |
| [Create-three-slide-presentation-with-entrance-animations.cs](./Create-three-slide-presentation-with-entrance-animations.cs) |  | Create three slide presentation with entrance animations |
