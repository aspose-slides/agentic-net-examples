...
class Program
{
    static void Main()
    {
        ...
        // Add a FloatUp animation effect to the shape
        ...
        effect.Timing.Accelerate = 0.3f; // 30% of the duration accelerates
        effect.Timing.Decelerate = 0.3f; // 30% of the duration decelerates

        // Define output path
        string outputPath = Path.Combine(Directory.GetCurrentDirectory(), "EasingEffect.pptx");
