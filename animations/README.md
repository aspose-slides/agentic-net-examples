...
- `Add-animation-timing-to-PDF-metadata.cs`

- `Add-click-reveal-bullet-points-animation.cs`

- `Add-color-change-animation-sync-sound.cs`

- `Add-custom-bezier-motion-path-animation.cs`

- `Add-custom-motion-path-and-set-duration.cs`

- `Add-fade-in-animation-to-title-placeholders.cs`

- `Add-fade-out-animation-to-images.cs`

- `Add-fade-spin-animation-to-chart.cs`

- `Add-slide-transitions-trigger-animations.cs`

- `Add-zoom-rotate-animation-preset.cs`

- `Copy-animations-from-one-slide-to-another.cs`

- `Create-three-slide-presentation-with-entrance-animations.cs`
