...
namespace ManageChartDataSeries
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            chart.Rotation3D.DepthPercents = (ushort)50;
            ...
            // Adjust overlap for the second series via its parent group
            series2.ParentSeriesGroup.Overlap = (sbyte)-20;

            // Save the presentation
            presentation.Save("ManagedChartSeries.pptx", Aspose.Slides.Export.SaveFormat.Pptx);
        }
    }
}